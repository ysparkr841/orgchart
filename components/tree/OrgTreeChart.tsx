...
export function OrgTreeChart({ roots, selectedId, onSelect, layout = "horizontal", onMove, highlightIds, focusId }: Props) {
  ...
  useEffect(() => {
    ...
    // Unified coordinate helpers — x = SVG horizontal, y = SVG vertical
    ...
    // Zoom group wrapping all content
    ...
    // Fit to screen on roots/layout change; preserve zoom on selectedId/highlight changes
